...
Po uruchomieniu programu zostanie utworzony plik
`resources/text_and_image.pdf.cache` zawierający mapę utworzoną z dokumentu oraz
pełną zawartość w formie tekstowej
